    ...
    <div className={` ${styles['Header']} ${styles[props.rootClassName]} `}>
      <div className={styles['container']}>
        <Link to="/" className={styles['navlink']}>
          <h1
            className={` ${styles['Heading']} ${projectStyles['textSM']} ${projectStyles['thqLink']} `}
          >
            {props.heading1}
          </h1>
        </Link>
        <Link to="/profile" className={styles['navlink1']}>
          <div
            className={` ${styles['container1']} ${projectStyles['thqLink']} `}
          >
        ...
        <Link to="/blog-post" className={styles['navlink2']}>
          <div
            className={` ${styles['container2']} ${projectStyles['thqLink']} `}
          >
      ...
      <div className={styles['container3']}>
        <svg viewBox="0 0 877.7142857142857 1024" className={styles['icon09']}>
        ...
        <svg viewBox="0 0 877.7142857142857 1024" className={styles['icon13']}>
