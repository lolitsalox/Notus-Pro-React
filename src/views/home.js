        ...
        <div className={styles['Team']}>
          <div className={styles['container23']}>
            ...
            <Link to="/profile" className={styles['navlink1']}>
              <div
                className={` ${styles['container29']} ${projectStyles['thqLink']} `}
              >
                <MemberDetails
            ...
            <Link to="/profile" className={styles['navlink2']}>
              <div
                className={` ${styles['container33']} ${projectStyles['thqLink']} `}
              >
                <MemberDetails
            ...
            <Link to="/profile" className={styles['navlink3']}>
              <div
                className={` ${styles['container38']} ${projectStyles['thqLink']} `}
              >
                <MemberDetails
          ...
          <div className={styles['Contact']}>
            ...
            <div className={styles['Form']}>
              ...
              <input
                ...
                className={` ${styles['textinput']} ${projectStyles['textSM']} ${projectStyles['thqTextInput']} `}
              />
              <span
              ...
              <input
                type="text"
                placeholder="Email"
                className={` ${styles['textinput1']} ${projectStyles['textSM']} ${projectStyles['thqTextInput']} `}
              />
              <span
